...
public class BlockLoader {
    ...
    // ECalculator blocks (meta: 0=casing, 1=thread_core, 2=hyper_thread, 3=parallel_proc, 4=cell_drive, 5=me_channel, 6=transmitter_bus, 7=tail)
    ...
    public static void registerBlocks() {
        ...
        estorageBlocks = new BlockECOAEMeta(
            ...
            new String[] { "blocks/estorage/casing", "blocks/estorage/cell_drive",
                "blocks/estorage/energy_cell", "blocks/estorage/me_channel", "blocks/estorage/vent" }
        );
        ...
        ecalculatorBlocks = new BlockECOAEMeta(
            "ecalculator_blocks",
            new String[] { "casing", "thread_core", "hyper_thread", "parallel_proc", "cell_drive",
                "me_channel", "transmitter_bus", "tail" },
            new String[] { "blocks/ecalculator/casing", "blocks/ecalculator/thread_core",
                "blocks/ecalculator/hyper_thread", "blocks/ecalculator/parallel_proc",
                "blocks/ecalculator/cell_drive", "blocks/ecalculator/me_channel",
                "blocks/ecalculator/transmitter_bus", "blocks/ecalculator/tail" }
        );
        ...
        efabricatorBlocks = new BlockECOAEMeta(
            ...
            new String[] { "blocks/efabricator/casing", "blocks/efabricator/worker",
                "blocks/efabricator/pattern_bus", "blocks/efabricator/parallel_proc",
                "blocks/efabricator/me_channel", "blocks/efabricator/vent" }
        );
