...
public class ItemLoader {
    ...
    // Item instances will be populated during registration
    ...
    /**
     * Register all items. Called during preInit.
     */
    ...
    /**
     * Register item renderers. Called during client init.
     */
    ...
    public enum ECOAEItemList implements IItemContainer {
        ...
        @Override
        public ItemStack getWildcard(int aAmount, Object... aReplacements) {
            return get(aAmount, aReplacements);
        }

        @Override
        public ItemStack getUndamaged(int aAmount, Object... aReplacements) {
            return get(aAmount, aReplacements);
        }

        @Override
        public ItemStack getAlmostBroken(int aAmount, Object... aReplacements) {
            return get(aAmount, aReplacements);
        }
        ...
        @Override
        public ItemStack getWithCharge(int aAmount, int aCharged, Object... aReplacements) {
            return get(aAmount, aReplacements);
        }

        @Override
        public ItemStack getWithDamage(int aAmount, long aDamageValue, Object... aReplacements) {
            ItemStack stack = get(aAmount, aReplacements);
